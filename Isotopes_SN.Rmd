...
#ggsave("Pb_isotopes_ratio_boxplot_transect.png", dpi = 300, height = 4, width = 9)
```
...
ratios_final <- ggarrange(ratios_box, ratios_scatter,
          labels = c("A","C"),
          nrow = 2,
          ncol = 1)
...
#ggsave("Figure S1.png", ratios_final, width = 240, height = 200, units = "mm",dpi = 300)

#ggsave("Figure S1.svg", ratios_final, width = 240, height = 200, units = "mm",dpi = 300)
