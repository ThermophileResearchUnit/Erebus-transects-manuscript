...
#ggsave("Figure S3.png", sup_fig_reads, width = 240, height = 120, units = "mm",dpi = 300)

#ggsave("Figure S3.svg", sup_fig_reads, width = 240, height = 160, units = "mm",dpi = 300)
...
erebus_asv <- erebus_p %>%
  filter(., OTU == "ASV_34" | Phylum == "Thaumarchaeota")

erebus_asv$Temperature <- as.factor(erebus_asv$Temperature)

erebus_asv$ASV_Phylum = paste(erebus_asv$Kingdom,
                                    erebus_asv$Phylum, erebus_asv$OTU)
