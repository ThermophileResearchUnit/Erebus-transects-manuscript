...
cap_plot_all <- ggplot(envdata.cn, aes(x= CAP1, y= CAP2, color = pH, 
  ...
  geom_text(label = "pH", x = arrows_x$pH, y = arrows_y$pH) +
    geom_text(label = "Conductivity", x = arrows_x$Conductivity, y = arrows_y$Conductivity) +
    ...
    geom_text(label = "C", x = arrows_x$Carbon, y = arrows_y$Carbon) +
      geom_text(label = "N", x = arrows_x$Nitrogen, y = arrows_y$Nitrogen) +
...
cap_plot_tr <- ggplot(envdata.cn_tr, aes(x= CAP1, y= CAP2, color = pH, 
  ...
  geom_segment(aes(x = 0.0, y =0.0,xend = arrows_tr_x$Fe, 
    ...
    geom_text(label = "pH", x = arrows_tr_x$pH, y = arrows_tr_y$pH) +
      geom_text(label = "C", x = arrows_tr_x$Carbon, y = arrows_tr_y$Carbon) +
      geom_text(label = "N", x = arrows_tr_x$Nitrogen, y = arrows_tr_y$Nitrogen) +
...
#ggsave("Figure 2E.png", cap_plot_all, width = 240, height = 90, units = "mm", dpi = 300)

#ggsave("Figure 2E.svg", cap_plot_all, width = 240, height = 90, units = "mm", dpi = 300)

#ggsave("Figure 3E.png", cap_plot_tr, width = 240, height = 90, units = "mm", dpi = 300)

#ggsave("Figure 3E.svg", cap_plot_tr, width = 240, height = 90, units = "mm", dpi = 300)
```
